...
def plot_histograms_from_csv_folder(data_dir, params=['C_D', 'S', 'k'], bins=30, figsize=(15, 10), data_type='train', n_cols=3):
    ...
    for idx, param in enumerate(params):
        ...
        if values:
            ...
            if param in ['k1']:  # проницаемость часто имеет широкий диапазон
...
if __name__ == "__main__":
    data_dir = "/home/ilnaz/PycharmProjects/datasets/new/radial_composite_inf/params"
    
    param_values = plot_histograms_from_csv_folder(
        data_dir=data_dir,
        params=['C_D', 'S', 'k1', 'M12', 'omega12', 'r_fD'],
        bins=500,
        figsize=(15, 8),
        data_type='val',
