...
def main():
    generator1 = InfiniteHomogeneousGenerator(30, 128,  200)
    generator2 = FiniteHomogeneousGenerator(30, 128, 200)
    generator3 = InfiniteDualPorosityGenerator(30, 128, 200)
    generator4 = FiniteDualPorosityGenerator(30, 128, 200)
    generator5 = InfiniteDualPermeabilityModelGenerator(30, 128, 200)
    generator6 = FiniteDualPermeabilityGenerator(30, 128, 200)
    generator7 = InfiniteRadialCompositeGenerator(30, 128, 200)
